    ...
    <body>
        <section class="container" style="min-height: 100vh;">
            <div class="question_answer">
                ...
                <h5 class="my-4 text-center">Subject: {{ $records[0]->exam->subject->name }},
                    ({{ $records[0]->exam->topic->name }})</h5>
                <hr>
                <a href="{{ route("exam_question_paper_pdf") }}" class="btn btn-primary btn-sm mb-3 me-end"><i
                        class="fa-solid fa-file-pdf"></i> Generate PDF</a>
                                ...
                                <p><strong>Your Answer:</strong>
                                    ...
                                    @elseif($record->submitted_answer !== $record->question->correct_answer)
                                        ...
                                        <p><strong>Correct answer:</strong>
                                            <span>{{ $record->question->correct_answer }}</span>
                                        </p>
                                    @else
            ...
            <a href="{{ route("dashboard") }}" class="btn btn-primary btn-sm text-white mt-4"><i
                    class="fa-solid fa-house"></i> Go Dashboard</a>
        </section>
